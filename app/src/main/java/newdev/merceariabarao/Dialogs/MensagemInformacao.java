...
{
    public static final String TITULO = " newdev.merceariabarao.Dialogs.mensageminformacao.titulo";
    public static final String MENSAGEM = " newdev.merceariabarao.Dialogs.mensageminformacao.mensagem";
